...
// https://github.com/google-deepmind/mujoco_mpc/blob/main/mjpc/simulate.h
#pragma once
...
#define MJGRASPLOCOMO_VISUAL_DEBUG (1)
#define MJGRASPLOCOMO_ACTUATOR_UI_DISABLED (1)
#define MJGRASPLOCOMO_ALL_SITES_ENABLED (1)
...
public:
  ...
  SimulateBase(std::unique_ptr<mujoco::PlatformUIAdapter> platform_ui_adapter, mjvCamera* cam, mjvOption* opt,
  ...
  // info strings
  char info_title[kMaxFilenameLength] = {0};
  char info_content[kMaxFilenameLength] = {0};
